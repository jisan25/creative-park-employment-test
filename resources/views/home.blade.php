...
@section('mainContent')
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex gap-3">
                <div class="rounded-lg">
                    <img class="rounded" id="imgSrc" alt="profile_image" style="width: 100px;object-fit:cover" />
            ...
            <div>
                <p style="font-size: 20px" id="showMessage"></p>
                <p>Upload Profile </p>
    ...
    <script>
        function loadImage() {
            let url = "{{ asset('images/' . auth()->user()->image) }}";
        ...
        // Image Upload using Jquery Ajax System
